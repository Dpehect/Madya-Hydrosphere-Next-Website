...
const regions = [
  { id: "ist", name: "ISTANBUL", x: 15, y: 32, load: "%94", nodes: 42 },
  { id: "ank", name: "ANKARA", x: 42, y: 44, load: "%82", nodes: 28 },
  { id: "izm", name: "IZMIR", x: 10, y: 55, load: "%78", nodes: 21 },
  ...
  { id: "gaz", name: "GAZIANTEP", x: 70, y: 78, load: "%68", nodes: 11 },
  { id: "kon", name: "KONYA", x: 40, y: 65, load: "%54", nodes: 9 },
  { id: "kay", name: "KAYSERI", x: 55, y: 52, load: "%48", nodes: 8 },
  { id: "diy", name: "DIYARBAKIR", x: 85, y: 68, load: "%42", nodes: 7 },
  { id: "esk", name: "ESKISEHIR", x: 30, y: 48, load: "%62", nodes: 10 },
  { id: "sam", name: "SAMSUN", x: 62, y: 25, load: "%51", nodes: 6 },
  { id: "den", name: "DENIZLI", x: 15, y: 65, load: "%38", nodes: 5 },
  { id: "mer", name: "MERSIN", x: 48, y: 82, load: "%59", nodes: 10 },
];
      ...
      <div className="container mx-auto max-w-[1700px] relative z-20">
           ...
           <div className="lg:col-span-3 space-y-12">
              <div className="space-y-4">
                 <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-mono text-cyber-blue tracking-[0.5em] uppercase px-4 py-1 border border-cyber-blue/20 rounded-full bg-cyber-blue/5">AG OPERASYONLARI</span>
                 </div>
                 <h1 className="text-5xl md:text-6xl font-bold font-syncopate text-white uppercase tracking-tighter leading-none">
                    MILLI <br />
                    <span className="text-cyber-blue">MATRIS</span>
                 </h1>
              </div>
              <div className="glass border border-white/5 p-6 md:p-8 rounded-[2.5rem] bg-black/40 space-y-4">
                 <span className="text-[8px] font-mono text-neutral-600 uppercase tracking-widest block mb-4">SEHIR SECIMI</span>
              ...
              <div className="grid grid-cols-1 gap-4">
                 <div className="p-6 glass border border-white/5 rounded-3xl flex items-center gap-6">
                    ...
                    <div>
                       <span className="block text-[8px] text-neutral-600 uppercase font-mono">DUGUMLER</span>
                       <span className="text-2xl font-bold text-white font-mono tracking-tighter">81 AKTIF</span>
                    </div>
                 </div>
              </div>
           </div>
                    ...
                    <div className="space-y-10">
                       <div className="space-y-4">
                          ...
                          <div>
                             ...
                             <p className="text-[10px] text-neutral-500 font-mono uppercase tracking-[0.4em]">KOMUTA MERKEZI</p>
                          </div>
                       </div>
                       <div className="space-y-6">
                          <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                             <span className="block text-[8px] font-mono text-neutral-500 uppercase mb-2">SAHA TRAFIGI</span>
        ...
        <div className="mt-10 md:mt-20 flex flex-col sm:flex-row justify-between items-center gap-8 glass border border-white/5 p-6 md:p-8 rounded-[2rem] md:rounded-[3rem] bg-black/60">
           ...
           <div className="flex items-center gap-4">
              ...
              <span className="text-[10px] text-white font-mono uppercase tracking-widest">SISTEM CEKIRDEGI AKTIF</span>
           </div>
        </div>
      </div>
        ...
        {showModal && (
          <>
            ...
            <motion.div 
              ...
              className="fixed bottom-0 left-0 right-0 z-[401] glass border-t border-cyber-blue/30 rounded-t-[3rem] p-8 lg:hidden bg-black/90 backdrop-blur-3xl shadow-[0_-20px_50px_rgba(0,243,255,0.15)] overflow-hidden"
            >
               <motion.div 
                 initial={{ top: "-100%" }}
                 animate={{ top: "100%" }}
                 transition={{ duration: 2, repeat: Infinity, ease: "linear" }}
                 className="absolute left-0 w-full h-[50%] bg-gradient-to-b from-transparent via-cyber-blue/5 to-transparent pointer-events-none z-0"
               />
                 ...
                 <div className="space-y-8">
                    <div className="flex items-center justify-between">
                       <div className="flex items-center gap-4">
                          ...
                          <div>
                             ...
                             <p className="text-[8px] text-neutral-500 font-mono uppercase tracking-[0.4em]">KOMUTA MERKEZI</p>
                          </div>
                       </div>
                       <button 
                         onClick={() => setShowModal(false)}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                       <div className="p-5 bg-white/5 rounded-2xl border border-white/5">
                          <span className="block text-[7px] font-mono text-neutral-500 uppercase mb-2">SAHA TRAFIGI</span>
                    ...
                    <div className="p-6 bg-cyber-blue/5 border border-cyber-blue/20 rounded-2xl flex items-center gap-4">
                       ...
                       <p className="text-[9px] font-mono text-neutral-400 uppercase leading-relaxed">
                          BOLGE SINYALI STABIL. VERI PAKETLERI MAZ-SYNC PROTOKOLU ILE AKTARILIYOR.
                       </p>
                    </div>
                 </div>
               </div>
